...
#define PERF_EVENT(EventString) \
  do { \
    if (LogPerformanceMeasurementEnabled (PERF_GENERAL_TYPE)) { \
      LogPerformanceMeasurement (NULL, NULL, EventString , 0, PERF_EVENT_ID); \
    } \
  } while (FALSE)
...
#define PERF_EVENT_SIGNAL_BEGIN(EventGuid) \
  do { \
    if (LogPerformanceMeasurementEnabled (PERF_GENERAL_TYPE)) { \
//////////////////////      LogPerformanceMeasurement (NULL, EventGuid, __FUNCTION__ , 0, PERF_EVENTSIGNAL_START_ID); \
    } \
  } while (FALSE)
...
#define PERF_EVENT_SIGNAL_END(EventGuid) \
  do { \
    if (LogPerformanceMeasurementEnabled (PERF_GENERAL_TYPE)) { \
//////////////////////      LogPerformanceMeasurement (NULL, EventGuid, __FUNCTION__ , 0, PERF_EVENTSIGNAL_END_ID); \
    } \
  } while (FALSE)
...
#define PERF_CALLBACK_BEGIN(TriggerGuid) \
  do { \
    if (LogPerformanceMeasurementEnabled (PERF_GENERAL_TYPE)) { \
//////////////////////      LogPerformanceMeasurement (NULL, TriggerGuid, __FUNCTION__ , 0, PERF_CALLBACK_START_ID); \
    } \
  } while (FALSE)
...
#define PERF_CALLBACK_END(TriggerGuid) \
  do { \
    if (LogPerformanceMeasurementEnabled (PERF_GENERAL_TYPE)) { \
//////////////////////      LogPerformanceMeasurement (NULL, TriggerGuid, __FUNCTION__ , 0, PERF_CALLBACK_END_ID); \
    } \
  } while (FALSE)
...
#define PERF_FUNCTION_BEGIN() \
  do { \
    if (LogPerformanceMeasurementEnabled (PERF_GENERAL_TYPE)) { \
//////////////////////      LogPerformanceMeasurement (NULL, NULL, __FUNCTION__ , 0, PERF_FUNCTION_START_ID); \
    } \
  } while (FALSE)
...
#define PERF_FUNCTION_END() \
  do { \
    if (LogPerformanceMeasurementEnabled (PERF_GENERAL_TYPE)) { \
//////////////////////      LogPerformanceMeasurement (NULL, NULL, __FUNCTION__ , 0, PERF_FUNCTION_END_ID); \
    } \
  } while (FALSE)
...
#define PERF_INMODULE_BEGIN(MeasurementString) \
  do { \
    if (LogPerformanceMeasurementEnabled (PERF_GENERAL_TYPE)) { \
      LogPerformanceMeasurement (NULL, NULL, MeasurementString, 0, PERF_INMODULE_START_ID); \
    } \
  } while (FALSE)
...
#define PERF_INMODULE_END(MeasurementString) \
  do { \
    if (LogPerformanceMeasurementEnabled (PERF_GENERAL_TYPE)) { \
      LogPerformanceMeasurement (NULL, NULL, MeasurementString, 0, PERF_INMODULE_END_ID); \
    } \
  } while (FALSE)
...
#define PERF_CROSSMODULE_BEGIN(MeasurementString) \
  do { \
    if (LogPerformanceMeasurementEnabled (PERF_GENERAL_TYPE)) { \
      LogPerformanceMeasurement (NULL, NULL, MeasurementString, 0, PERF_CROSSMODULE_START_ID); \
    } \
  } while (FALSE)
...
#define PERF_CROSSMODULE_END(MeasurementString) \
  do { \
    if (LogPerformanceMeasurementEnabled (PERF_GENERAL_TYPE)) { \
      LogPerformanceMeasurement (NULL, NULL, MeasurementString, 0, PERF_CROSSMODULE_END_ID); \
    } \
  } while (FALSE)
